...
A small Flask service that listens for Strava activity-created webhooks and rewrites each new activity's distance to a "lucky-number" form `N.NN` km (e.g. `7.07 km`, `12.12 km`). Designed to run as a long-lived web service on Railway.
